    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          ...
          boxes_show.append([ymin, xmin, ymax, xmax])
          names_show.append(class_name)

          print(i,class_name,int(100*scores[i]),xmin+((xmax-xmin)/2),ymin+((ymax-ymin)/2))   
        else:
