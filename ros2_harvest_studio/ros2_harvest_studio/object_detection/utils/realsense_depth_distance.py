...
def convert_depth_pixel_to_metric_coordinate(depth, pixel_x, pixel_y, x_1, x_2, sum_depth):
    ...
    X = int((depth + (X_2-X_1)/2)* math.tan(theta_x))
    Y = int((-1)* (depth + (X_2-X_1)/2)* math.tan(theta_y))
